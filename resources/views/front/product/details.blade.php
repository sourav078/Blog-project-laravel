                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="{{asset('/')}}frontend/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <img src="{{asset($product->image)}}frontend/img/product-2.jpg" alt="">
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name">{{$product->category_name}}</h2>
                                    <div class="product-inner-price">
                                        <ins>$700.00</ins> <del>$100.00</del>
                                    </div>

                                    <div class="product-inner-category">
                                        <p>Category: <a href="{{$product->category_name}}">Brand</a>. Tags: <a href=""></a> <a href="">{{$product->product_name}}</a> </p>
                                    </div>
