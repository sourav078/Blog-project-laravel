            ...
            <div class="col-md-8">
                <div class="user-menu">
                    <ul>
                        ...
                        @if(auth()->check())
                        <li>
                            <a href="#" onclick="event.preventDefault();document.getElementById('logoutForm').submit();"><i class="fa fa-user"></i> Logout</a>
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    @foreach($categories as $category)
                        <li><a href="{{ route('categories', $category->id) }}">{{$category->category_name}}</a></li>
                    @endforeach
